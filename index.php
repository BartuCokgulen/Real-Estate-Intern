...
<section class="testimonials-section py-5 bg-light">
    <div class="container" data-aos="fade-up" data-aos-duration="1000">
        ...
        <p class="text-center text-muted mb-5">Hear from our satisfied clients about their experience with us</p>
        
        <div class="owl-carousel testimonials-carousel">
            <div class="item" data-aos="fade-up" data-aos-delay="100">
                <div class="testimonial-card">
                    <div class="testimonial-content">
                        <p>"I was amazed by the professionalism and dedication of the team. They helped me find my dream home in just a few weeks. The entire process was smooth and stress-free."</p>
                    </div>
            ...
            <div class="item" data-aos="fade-up" data-aos-delay="200">
                <div class="testimonial-card">
                    <div class="testimonial-content">
                        <p>"The market insights provided by the agents were invaluable. They helped me make an informed decision and find a property that not only met my needs but also proved to be a great investment."</p>
                    </div>
                    <div class="testimonial-author">
                        <div class="testimonial-avatar">
            ...
            <div class="item" data-aos="fade-up" data-aos-delay="300">
                <div class="testimonial-card">
                    <div class="testimonial-content">
                        <p>"As a first-time homebuyer, I was nervous about the process. The team guided me through every step, explaining everything clearly and making sure I was comfortable with each decision."</p>
                    </div>
                    <div class="testimonial-author">
                        <div class="testimonial-avatar">
            ...
            <div class="item" data-aos="fade-up" data-aos-delay="400">
                <div class="testimonial-card">
                    <div class="testimonial-content">
                        <p>"I've worked with several real estate agencies before, but none compare to the level of service and attention to detail I received here. They truly go above and beyond for their clients."</p>
                    </div>
                    <div class="testimonial-author">
                        <div class="testimonial-avatar">
